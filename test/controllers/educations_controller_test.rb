...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { course: @education.course, institution: @education.institution, institution_type: @education.institution_type, year_finished: @education.year_finished, year_started: @education.year_started } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { course: @education.course, institution: @education.institution, institution_type: @education.institution_type, year_finished: @education.year_finished, year_started: @education.year_started } }
